...
class BackendService {
  ...
  final List<MenuItemModel> _menuItems = [
    ...
    MenuItemModel(id: 'hc_1', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Cheese Pattie', price: 30, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_2', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Cheese Burger', price: 60, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_3', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Cheese Fried Rice', price: 100, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_4', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Cheese Sandwich', price: 50, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_5', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Cheese Noodles', price: 100, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_6', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Aloo Pattie', price: 20, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_7', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Tea', price: 15, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_8', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Cold Coffee', price: 50, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_9', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Paneer Rice', price: 80, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_10', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Veg Fried Rice', price: 80, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_11', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Veg Grilled Sandwich', price: 90, isVeg: true, isAvailable: true),
    MenuItemModel(id: 'hc_12', restaurantId: 'rest_003', restaurantName: 'Hostel Canteen', foodName: 'Veg Maggi', price: 40, isVeg: true, isAvailable: true),
